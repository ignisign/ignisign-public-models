...
export enum IGNISIGN_ERROR_CODES {
  ...
  // Signer group
  SIGNER_GROUP_NOT_FOUND                    = "SIGNER_GROUP_NOT_FOUND",
  EMAIL_DOMAIN_ALREADY_USED_IN_ANOTHER_SIGNER_GROUP = "EMAIL_DOMAIN_ALREADY_USED_IN_ANOTHER_SIGNER_GROUP",
  SIGNER_GROUP__INVALID_SIGNATURE_METHOD  = "SIGNER_GROUP__INVALID_SIGNATURE_METHOD",
